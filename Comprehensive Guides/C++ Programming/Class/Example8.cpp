...
Memory efficient: Now we don't need to create instance for accessing the static members, so it saves memory. Moreover, it belongs to the type, 
...
class Account {  
   public:  
       ...
       void display()    
        {    
            cout<<this->accno<<this->name<<rateOfInterest<<endl;   
        }    
};  
